...
제 연구는 **암흑물질 현상론**과 **과학 머신러닝**의 간극을 메워, 전통적인 분석 방법과 현대 AI 기술을 통해 기초 물리학을 이해하는 통합적 접근법을 만듭니다.

저는 우주론적 관측, 천체물리학적 제약조건, 그리고 새로운 계산 방법을 결합하여 암흑물질 후보—특히 원시 블랙홀과 액시온 유사 입자—를 연구합니다. 동시에, AI가 단순히 데이터를 맞추는 것이 아니라 이러한 시스템을 지배하는 근본적인 물리 법칙을 진정으로 이해하고 모사할 수 있도록 하는 **연산자 학습 프레임워크**를 개발합니다.
